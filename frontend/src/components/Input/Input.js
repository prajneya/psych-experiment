  ...
  return (
    <div className="container text-center p-5">
      ...
      <p>
        ...
        a project being done to study the effects of word memorability. The
      ...
      <p>
        <b>
          Try to recall as many words as you can and enter them in the box below
          (space separated). Press the PROCEED Button once you are done.
        </b>
      </p>

...
function Final() {
  ...
  function proceed() {
    ...
    if (chosen_game !== "") {
      axios
        .post("/api/experiment/updateGame", {
          id: id,
          game_chosen: chosen_game,
        })
        .then((res) => {
          console.log(res);
  ...
  return (
    <div className="container text-center p-5">
      ...
      <br />
      <p>
        If you had to choose one of the games to play, which one will you
        choose? Select a game by clicking on the radio button below and click on
        the proceed button
      </p>
